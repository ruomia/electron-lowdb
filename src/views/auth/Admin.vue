  ...
  <div>
    <el-form :inline="true" :model="query" class="query-form" size="mini">
      <el-form-item class="query-form-item">
        <el-input v-model="query.user_name" placeholder="用户名"></el-input>
      </el-form-item>
      <el-form-item class="query-form-item">
    ...
    <el-table v-loading="loading" :data="list" style="width: 100%;">
      ...
      <el-table-column label="用户名" prop="user_name" fixed></el-table-column>
    ...
    formSubmit() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          adminSave(data, this.formName).then(response => {
