<template>
  <div class="login-container" :style="{height: winHeight +'px'}">
    <el-form
    ...
    >
      ...
      <el-form-item prop="username" class="item">
        <el-input placeholder="账号" name="userName" autocomplete="on" v-model="ruleForm.userName">
...
// getFocusedWindow 返回此应用程序中当前获得焦点的窗口，如果无就返回 null.
...
export default {
  ...
  created() {
    ...
    win.on('resize', e => {
      // 获取窗口内容的宽度和高度
      let sizes = e.sender.getContentSize()
      this.winHeight = sizes[1]
    })
  }
}
</script>
